<x-layout>
    <div class="bg-white p-6 rounded-xl shadow-lg w-full max-w-5xl mt-5 mb-5">
        <h1 class="text-2xl font-bold border-b-4 border-purple-500 inline-block pb-1"
            alt="Formulier voor het bewerken van een event">
            Community avond bewerken
        </h1>

        @if(session('success'))
            <div class="w-full flex justify-center">
                <div class="max-w-md p-4 my-4 bg-green-100 border-l-4 border-green-500 text-green-700 rounded-lg">
                    <p class="font-medium">{{ session('success') }}</p>
                </div>
            </div>
        @endif

        <form method="POST" action="{{ route('community-nights.update', $communityNight->id) }}"
            ...
            <div>
                ...
                <input type="text" name="title" id="title" placeholder="Titel van het event"
                       aria-label="Communityavond title bewerken"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="datetime-local" name="start_time" id="start_time"
                           ...
                           value="{{ old('start_time', $communityNight->formatted_start_time) }}"
                ...
                <div>
                    ...
                    <input type="datetime-local" name="end_time" id="end_time"
                           ...
                           value="{{ old('end_time', $communityNight->formatted_end_time) }}"
            ...
            <div>
                ...
                <input type="text" name="location" id="location" placeholder="Locatie van het event"
            ...
            <div>
                ...
                <input type="url" name="link" id="link" placeholder="Link naar het event"
