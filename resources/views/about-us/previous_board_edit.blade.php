<x-layout>
    <div class="bg-white p-6 rounded-xl shadow-lg w-full max-w-5xl mt-5 mb-5">
        ...
        <form method="POST" action="{{ route('previous-boards.update', $previousBoard->id) }}"
            ...
            <div>
                ...
                <input type="date" name="FromYear" id="FromYear"
                       value="{{ old('FromYear', $previousBoard->FromYear) }}"
            ...
            <div>
                ...
                <input type="date" name="ToYear" id="ToYear"
                       value="{{ old('ToYear', $previousBoard->ToYear) }}"
            ...
            <div>
                ...
                @if ($previousBoard->photo)
                    <img src="{{ Storage::url($previousBoard['photo']) }}"
                         alt="Groepsfoto van de bestuurders uit periode {{ \Carbon\Carbon::parse($previousBoard->FromYear)->format('Y') }} - {{ \Carbon\Carbon::parse($previousBoard->ToYear)->format('Y') }}"
